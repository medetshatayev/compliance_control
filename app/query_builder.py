...
class QueryBuilder:
    ...
    def build_query(self) -> str:
        ...
        Your task is to screen entities, banks, organizations, countries, goods, banks, routes, contracts, manufacturers, HS codes for sanctions risks.
...
"""
            query_text += """{
  "data": {
    "CLIENT": "ТОО \\"Импортёр Казахстан\\"",
    "COUNTERPARTY_NAME": "ПАО \\"Сбербанк России\\"",
    "CONSIGNEE": "Казахстанский получатель",
    "MANUFACTURER": "Российский поставщик",
    "BIK_SWIFT": "SABRRUMM",
    "CROSS_BORDER": "0",
    "ROUTE": "RU-KZ",
    "HS_CODE": "8517709000",
    "PRODUCT_NAME": "Оборудование для телекоммуникаций",
    "CONTRACT_TYPE": "Импорт",
    "CONSIGNOR": "Placeholder Company LLC",
    "CONTRACT_CURRENCY": "USD",
    "PAYMENT_CURRENCY": "USD",
    "CURRENCY_CONTRACT_NUMBER": "CONTRACT-2025-001",
    ...
    "CORRESPONDENT_BANK_NAME": "Halyk Bank Kazakhstan",
    "CONTRACT_DESCRIPTION": "Договор поставки телекоммуникационного оборудования",
    "PAYMENT_METHOD": "14",
    "REPATRIATION_TERM": "180.00",
    "DOCUMENT_REFERENCES": "Спецификация №1, Счет-фактура",
    "COUNTERPARTY_COUNTRY": "RU",
    "AMOUNT": "1000000.00",
    "THIRD_PARTIES": "Нет",
    "CONTRACT_NAMES": "Иванов И.И., Петров П.П.",
    "UN_CODE": "1",
...
"""
            query_text += f"""{entity_variants_text}
